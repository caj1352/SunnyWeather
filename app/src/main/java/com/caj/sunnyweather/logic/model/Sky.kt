package com.caj.sunnyweather.logic.model

import com.caj.sunnyweather.R
...
private val sky = mapOf("CLEAR_DAY" to Sky("晴", R.drawable.ic_clear_day, R.drawable.bg_clear_day)
    ...
    , "SLEET" to Sky("雷夹雪", R.drawable.ic_sleet, R.drawable.bg_snow)
    ...
    , "HAIL" to Sky("冰雹", R.drawable.ic_hail, R.drawable.bg_fog)
